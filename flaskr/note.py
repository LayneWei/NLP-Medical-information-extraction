...
def combined_cosine_similarity_flair(filename, concept, in_txt):
    ...
    concept_words = Sentence(str(filename[:-3]) + concept)
...
## Main index page - people upload the output .csv file and the .txt files here
...
## UI goes through .csv file, extracts all concepts and displays important information to user
...
def display_concept(i_txt_file, concept_chosen, beginning, filename):
    ...
    cosine_flair = combined_cosine_similarity_flair(filename, concept_calc, range_calc)
